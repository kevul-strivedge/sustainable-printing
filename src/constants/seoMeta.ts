...
export const seoMetaBySlug: Record<string, SeoMeta> = {
  '': { title: 'Eco-Friendly Green Printing | Sustainable Printing Australia', description: 'Sustainable Printing Co. is an Eco-Friendly Green Printing Service Provider in Australia. We Print on 100% Recycled Papers to Provide Eco-Friendly Green Printing.', keywords: 'Recycled Printing, Eco Printing, Eco-Friendly Printing, Recycled Business Cards, Recycled Postcards, Custom Printing services, Printing Company, Sustainable Printing' },
  'dealofweek': { title: 'ECO Friendly Printing Services Weekly Deals', description: 'We are australia\'s one of the leading Eco-Friendly printing company. Offers a deal of the week on recycled business cards, postcards and more.', keywords: 'Deal of the week on Eco Printing, Recycled Printing, Eco-Friendly Printing Company, Recycled Printing in Australia' },
  'business-cards': { title: 'Eco-Friendly Recycled Business Cards | Sustainable Printing', description: 'We offer eco-friendly & cost-effective recycled business card printing services in Australia. Contact us now for a free card sample.', keywords: 'Business Cards Printing, Recycled Business Cards, Affordable business cards printing, Eco-friendly Business Cards, Recycled Uncoated Business cards, Brown-Kraft Business Cards' },
  'product-details': { title: 'Product-details-title', description: 'Product-details-desc', keywords: 'Product-details' },
  'postcards': { title: 'Recycled Postcards Printing Services | Sustainable Printing', description: 'Sustainable Printing provides premium quality recycled postcard printing services at affordable prices. Get your free recycled postcard sample pack now.', keywords: 'Affordable postcard printing in Australia, Recycled Postcards Printing, Kraft Postcards, Premium Postcards, 100% recycled Postcards' },
  'products': { title: 'Recycled Business Cards, Greeting Cards, Postcards, Gift Cards', description: 'Sustainable Printing Co. provides 100% recycled paper printing services like recycled business cards, postcards, greeting & card printing & many others.', keywords: 'Business Card, Postcard Printing, Gift Cards, Swing Tags, Adhesive labels or Stickers, Booklets and Reports, Flyers and posters Printing, Brochures folded, Stationery, Green Printing' },
  'gift-cards': { title: 'Recycled Gift Cards Printing Services | Sustainable Printing', description: 'Sustainable Printing Co. provides customized recycled gift card printing services for any special occasion. Order your free recycled gift card sample pack.', keywords: 'Gift Cards Printing, Greeting Cards Printing Services, Affordable Gift Cards Printing Australia' },
  'swing-tags': { title: 'Recycled Swing Tags Printing Services | Sustainable Printing', description: 'Sustainable Printing Co. offers premium quality recycled swing tag printing services at an affordable price. Order your free recycled swing tag sample pack now.', keywords: 'Swing Tags Printing, Products Tags Printing, Recycled Paper Printing in Australia, Premium Swing Tags, Kraft Swing tags' },
  'label-stickers': { title: 'Adhesive Labels & Stickers Printing | Sustainable Printing', description: 'Sustainable Printing is one of the leading label & stickers printing providers in Australia. We offer eco-friendly adhesive labels & sticker printing services.', keywords: 'Adhesive Labels Printing, Strikers Printing, Custom Adhesive Labels Print, Circle Adhesive Labels, Square Adhesive Labels, Rectangle Adhesive Labels' },
  'booklet-report': { title: 'Recycled Booklets and Reports Printing | Sustainable Printing', description: 'Sustainable Printing provides Recycled Booklet & Report Printing Services at an affordable price. Order your free Recycled Booklets and Reports Printing Sample.', keywords: 'Booklet Printing Services Australia, Report Printing, Affordable Booklet Printing' },
  'flyer-poster': { title: 'Eco-Friendly Flyers & Posters Printing | Sustainable Printing', description: 'Sustainable Printing offers a range of Eco-Friendly Posters & Flyers Printing in different sizes. Order your free Eco-Friendly Flyers & Posters Printing Sample.', keywords: 'Flyers Printing, Posters Printing, Flyers Printing Services Australia, Posters Printing Services Australia, Custom Flyers, Custom Posters' },
  'brochures': { title: 'Custom Folded Brochures Printing | Sustainable Printing', description: 'Sustainable Printing Co. offers a range of custom folded brochures printing in different sizes. Order your free eco-friendly folded brochure printing sample now.', keywords: 'Brochures Printing, Eco friendly brochures printing Australia, Affordable Brochures Printing Australia' },
  'stationary': { title: 'Business Stationery & Letterhead Printing Services', description: 'Sustainable Printing Co. offers business stationery, wrapping paper, letterhead & compliment slips printing at the best price. order your free stationery sample.', keywords: 'Stationery Printing, Affordable Stationery Printing Services' },
  'custom-quote': { title: 'Get Quote on Eco-Friendly Recycled Printing', description: 'Sustainable Printing Co. offers 100% recycled, eco-friendly printing services at an honest price. Get a quote for eco-friendly and recycled printing services.', keywords: 'Eco Printing Company, Recycled Printing, Printing Company in Australia' },
  'faq': { title: 'FAQ - Eco-Friendly Printing Services – Sustainable Printing Co.', description: 'Check out all the faq for eco printing, green printing, artwork, & product-related questions from one of the leading eco-friendly printing companies in Melbourne.', keywords: 'Eco Printing Company in Australia, Eco Printing' },
  'contact': { title: 'Contact Us – Sustainable Printing Co.', description: 'Looking for an Eco-Friendly printing service provider in Australia? Then contact one of the leading Green printing services providers – Sustainable Printing Co.', keywords: 'Eco printing services, Sustainable Printing, Eco-friendly printing company in Australia' },
  'requestsample': { title: 'Request Recycled Paper Sample Pack from Us.', description: 'Visit us now, fill in the details, and request a sample pack of recycled paper from one of the leading green printing services providers in Australia.', keywords: 'Request Recycled Paper Sample Pack, Sustainable Printing' },
  'login': { title: 'Login to Your Account – Sustainable Printing Co.', description: 'Welcome & login to your account. Sustainable Printing Co. provides complete green printing solutions in Australia.', keywords: 'Sustainable Printing Co' },
  'about': { title: 'One of the Leading Eco Printing Services Provider', description: 'We are an Australian eco-friendly printing company. We specialize in eco-friendly printing on 100% recycled paper using eco-friendly inks. Connect Now.', keywords: 'Eco printing services, Sustainable Printing, Eco-friendly printing company in Australia' },
  'brown-kraft-business-cards': { title: 'Brown Kraft Business Cards Printing in Australia', description: 'Buy Brown Kraft Business Cards from Sustainable Printing Co. at the best price. We offer 100% recycled kraft paper in Melbourne & Fitzroy.', keywords: 'Kraft Business Cards' },
  'uncoated-business-cards': { title: '100% Recycled Business Cards Printing in Melbourne', description: 'Get premium business cards. Sustainable Printing Co. offers eco-friendly business card printing services in Melbourne, Richmond & Fitzroy.', keywords: 'Premium Uncoated Business cards' },
  'premium-postcards': { title: 'Premium Postcards Printing in Melbourne, Fitzroy', description: 'We provide high-quality premium postcards that are available in different sizes & papers. We deliver recycled premium postcards as per custom requirements.', keywords: 'Premium Postcards' },
  'kraft-postcards': { title: 'Brown Kraft Postcards Printing in Collingwood, Richmond', description: 'Sustainable Printing Co. is the leading green printing service provider in Australia. We offer Brown Kraft postcard printing services at best prices.', keywords: 'Kraft Postcards' },
  'standard-a6-gift-cards': { title: 'A6 Gift Cards Printing in Australia | Green Printing Services', description: 'Sustainable Printing Co. offers high-quality affordable gift card printing services in Fitzroy, Richmond, & Melbourne. Contact us now for services.', keywords: 'Standard A6 Gift Cards' },
  'square-gift-cards': { title: 'Square Gift Cards Printing in Australia | Square Gift Cards', description: 'Order your square gift cards from Sustainable Printing Co. We offer custom gift card printing services on recycled papers at affordable prices.', keywords: 'Square Gift Cards' },
  'premium-swing-tags': { title: 'Premium Swing Tags Printing Collingwood, Richmond', description: 'Sustainable Printing Co. offers premium swing tag printing services across Australia. You can convey your message using premium swing tags.', keywords: 'Premium Swing Tags' },
  'kraft-swing-tags': { title: 'Kraft Swing Tags | Swing Tags Printing in Australia | Sustainable Printing Co.', description: 'As a one of the leading green printing service provider company – Sustainable Printing Co. offers custom swing tags printing services on 100% recycled kraft (brown) paper.', keywords: 'Kraft Swing tags' },
  'circle-adhesive-labels': { title: 'Circle Adhesive Labels Printing | Round Labels for Printing', description: 'Create your own custom adhesive label with us. We have a wide range of eco-friendly adhesive labels like round labels, gloss, kraft, & stickers..', keywords: 'Circle Adhesive Labels' },
  'square-stickers': { title: 'Square Stickers & Square Labels Printing Services in Australia | Eco Friendly', description: 'Create custom square stickers for packaging, branding and handouts with eco friendly paper, full colour printing, flexible quantities and Australian production.', keywords: 'Square Stickers' },
  'flyers-printing': { title: 'Affordable Flyers Printing Services in Australia', description: 'Looking for environmentally promotional flyers in Australia? Sustainable Printing Co. offers eco-friendly flyer printing options across Australia.', keywords: 'Flyers Printing Services' },
  'posters-printing': { title: 'Posters Printing Services in Australia', description: 'Sustainable Printing Co. offers poster printing services on post-consumer recycled paper. We have a wide range of poster sizes available to us.', keywords: 'Posters Printing Services' },
  'brochures-printing': { title: 'Custom Brochures Printing Services in Australia', description: 'The brochure is the best way to share your company information. Sustainable Printing Co. offers discounts on printing services across Australia.', keywords: 'Brochures Printing Services' },
  'letterhead-printing': { title: 'Letterhead Printing Services in Australia', description: 'If you\'re looking for letterhead printing services in Australia? Sustainable Printing Co. will provide Green printing services at an affordable price.', keywords: 'Letterhead Printing Services' },
  'compliment-slips': { title: 'Compliment Slips Printing | Stationary Printing in Australia', description: 'Print your compliment slips with Sustainable Printing Co. We provide compliment slip printing services using 100% recycled paper Australia-wide', keywords: 'Compliment Slips' },
  'a2-wrapping-paper': { title: 'A2 Wrapping Paper | Wrapping Paper Printing in Australia', description: 'Sustainable Printing Co. wrapping paper printing service on 100% recycled paper. print wrapping paper with us, delight customer with neatly wrapped purchase', keywords: 'A2 Wrapping Paper' },
  'a4-self-cover-booklets': { title: 'A4 Self Cover Booklets | Booklets Printing in Australia | Sustainable Printing Co.', description: 'Booklets can be used for the promotion of your business like sales catalog, promotional booklet, etc. Sustainable Printing Co. offers booklet printing services in 100% recycled paper.', keywords: 'A4 Self Cover Booklets' },
  'a4-plus-cover-booklets': { title: 'A4 Plus Cover Booklets | Booklet Printing in Collingwood, Richmond, Melbourne', description: 'Sustainable Printing Co. offers A4 Plus Cover Booklet printing on 300gsm white uncoated cover & 100% post-consumer recycled paper at an affordable price in Australia wide.', keywords: 'A4 Plus Cover Booklets' },
  'a5-self-cover-booklets': { title: 'A5 Self Cover Booklets | Promotional Booklet Printing in Sydney, Richmond, Fitzroy', description: 'Sustainable Printing Co. offers recycled printing services for A5 Self Cover Booklets using 100% recycled papers. Contact us now & get a discount on green printing services.', keywords: 'A5 Self Cover Booklets' },
  'a5-plus-cover-booklets': { title: 'Get a Custom Quote for A5 Plus Cover Booklets Printing | Sustainable Printing Co.', description: 'At Sustainable Printing Co. we offer A5 Plus Cover Booklets printing on different paper type. We are one of the leading environment-friendly printing service providers in Australia.', keywords: 'A5 Plus Cover Booklets' },
  'environmentally-friendly-inks-toner': { title: 'Environmentally Friendly Inks and Toners | Sustainable Printing', description: 'Sustainable Printing uses vegetable-based inks for its offset printing. We are committed to delivering Environmentally Friendly printing solutions.', keywords: 'Eco-Friendly Printing Inks and Toners' },
  'reducing-waste': { title: 'Reducing Environmental Waste| Sustainable Printing Australia', description: 'Sustainable Printing Co operates under a \'Lean-Green Manufacturing\' process. We use 100% recycled papers, which are manufactured carbon neutral.', keywords: 'Reducing Waste' },
  'greenpower': { title: 'GreenPower Accredited Renewable Energy Sustainable Printing', description: 'Sustainable Printing uses GreenPower which contributes to the decrease in greenhouse gas emissions that are associated with traditional electricity generation.', keywords: 'GreenPower' },
  'recycled-paper': { title: '100% Recycled Paper Printing | Sustainable Printing Australia', description: 'When you print with us, you can be satisfied knowing that your Business Card, Invitation, Postcard, Greeting Card has been printed on 100% recycled papers.', keywords: 'Recycled Paper' },
  'why-we-print-sustainably': { title: 'Eco Friendly Printing with Sustainable Printing Solutions', description: 'At Sustainable Printing, our commitment to using GreenPower and 100% post-consumer waste recycled papers has a multitude of positive flow on effects.', keywords: 'Printing with Sustainable' },
  'printpaper-mythsfacts': { title: 'Printing Paper - Myths And Facts | Sustainable Printing', description: 'Myths And Facts about Printing Papers. Making Paper Destroys Forests? Paper and Print is a Wasteful Product? Paper is bad for the Environment?', keywords: 'Printing Paper - Myths And Facts' },
  'rectangle-stickers': { title: 'Rectangle Sticker Printing Australia | Recycled Paper Labels', description: 'Print rectangle stickers and adhesive labels with recycled paper choices, custom sizes, vibrant colour printing and fast Australian production service.', keywords: 'Rectangle Stickers Printing | Eco-Friendly Adhesive Stickers' },
  'bookmarks': { title: 'Eco Friendly Bookmarks | Recycled Paper Bookmarks', description: '100% post-consumer recycled paper with 350gsm white, uncoated. Natural look and feel. Bulky Bookmarks available in a range of sizes.', keywords: 'Eco Friendly Bookmarks | Recycled Paper Bookmarks' },
  'calenders': { title: 'Eco Friendly Calendar Printing | A4 Wall Calendars Printed', description: 'Get eco friendly calendar printing with Sustainable Printing Company. 100% post-consumer recycled paper for A4 wall calendars printing.', keywords: 'Eco Friendly Calendar Printing | A4 Wall Calendars Printed' },
  // meta.xlsx has TWO rows with key 'thank-you-card-printing' (rows 49 + 60).
  // Laravel's PHP foreach overwrites — keep the LATER row's content.
  'thank-you-card-printing': { title: 'Recycled Paper Thank You Cards | Sustainable Printing', description: 'Our Recycled Thank You Card are perfect for gifts, to print your illustrations, drawing and painting and to use as hand outs. Contact Now.', keywords: 'Recycled Paper Thank You Cards | Sustainable Printing' },
  'books': { title: 'Custom Book Printing Australia | Book Printing Company', description: 'Explore eco-friendly custom book printing in Australia. We print books of all kinds with sustainable materials. Short runs to bulk—crafted to match your vision.', keywords: 'Eco Friendly Books, Booklets, Reports | Sustainable Printing' },
  'bookmarks-printing': { title: 'Eco Friendly Bookmarks Printing | Sustainable Printing', description: 'Contact us for Eco Friendly Bookmarks Printing with 100% post-consumer recycled paper, 350gsm white, uncoated & available in various size for your selection', keywords: 'Eco Friendly Bookmarks Printing | Sustainable Printing' },
  'printers-near-me': { title: 'Printers Near Me | Printing Services Near Me | Sustainable Printing', description: 'Click on Sustainable Printing Co. whenever you search for printing services near me for economical and earth-friendly printing solutions.  Contact Now.', keywords: 'Printers Near Me | Printing Services Near Me | Sustainable Printing' },
  'folded-a6-christmas-cards': { title: 'Folded A6 Christmas Cards | Christmas Cards Printing', description: 'We have the best collection of Christmas cards Printing. Find the perfect recycled eco-friendly Folded A6 Christmas Cards and order it now.', keywords: 'christmas cards printing' },
  'discount-cards': { title: 'Recycled Eco Friendly Discount Cards Printing Australia', description: 'Greet your customers with recycled eco-friendly discount card printing. Ask for samples and templates of various designs, styles, sizes.', keywords: 'discount cards printing' },
  'appointment-cards': { title: 'Recycled Eco Friendly Appointment Cards Printing Australia', description: 'Communicate that your appointment is Eco-Friendly with our range of recycled appointment cards. From 350gsm 100% recycled Uncoated Appointment cards.', keywords: 'appointment cards printing' },
  'loyalty-cards': { title: 'Loyalty Cards Printing | Recycled ECO Friendly Loyalty Cards', description: 'Communicate that your loyalty card is Eco-Friendly with our range of recycled loyalty cards. From 350gsm 100% recycled Uncoated.', keywords: 'loyalty cards printing' },
  'birth-announcement-cards': { title: 'Recycled Eco-Friendly Birth Announcement Card Printing', description: 'Our Recycled Eco-Friendly Birth Announcement Cards are perfect for gifts, to print your illustrations, drawing and painting and to use as hand outs.', keywords: 'birth announcement card printing' },
  'invitations': { title: 'Recycled Eco-Friendly Invitations Cards Printing Australia', description: 'Our Recycled Eco-Friendly Invitations Cards are perfect for gifts, to print your illustrations, drawing and painting and to use as handouts.', keywords: 'invitations cards printing' },
  'save-the-date-cards': { title: 'Recycled Eco-Friendly Save The Date Cards Printing Australia', description: 'Our Recycled Eco-Friendly Save The Date Cards are perfect for gifts, printing your illustrations, drawing, and painting, and to use as handouts.', keywords: 'save the date cards printing' },
  'melbourne-printers': { title: 'Printers Melbourne | Melbourne Printing Services Company', description: 'Our Melbourne printing services encompass a wide range of options, including digital and offset printing, bookbinding, and more. Contact now.', keywords: 'Printers Melbourne' },
  'blogs/business-card-printing-services-a-sustainable-approach': { title: 'Business Card Printing Services Are a Sustainable Approach', description: 'Make a positive impact on the environment with our sustainable business card printing services. Choose from a variety of eco-friendly materials', keywords: 'Business Card Printing Services' },
  'blogs/affordable-flyers-printing-services': { title: 'Select  Affordable Flyers Printing Services for Your Business', description: 'Looking for budget-friendly flyer printing services? We offers cost-effective solutions to meet your business requirements. Explore our services today!', keywords: 'Affordable Flyers Printing Services' },
  'blogs/choosing-the-right-business-card-printing-service': { title: 'Choosing the Right Business Card Printing Service: Key Considerations', description: 'Discover essential factors to consider when choosing the ideal business card printing service. Find expert tips and advice to make the right decision.', keywords: 'Business Card Printing Service' },
  'blogs/choosing-the-right-printing-partner-adhesive-labels-edition': { title: 'Choosing the Right Printing Partner for Adhesive Labels Edition', description: 'Need an expert in adhesive labels? Visit our website to find the perfect printing partner. Benefit from our expertise and exceptional printing solutions tailored to your needs.', keywords: 'Adhesive Labels' },
  'blogs/eco-friendly-impressions-sustainable-postcard-printing-services': { title: 'Postcard Printing Services That Are Environmentally Friendly', description: 'Get eco-friendly postcard printing services for sustainable solutions on our website. Choose green printing options for a more environmentally friendly approach.', keywords: 'Postcard Printing Services' },
  'blogs/eco-friendly-sticker-printing-redefining-sustainability-in-australia': { title: 'Environmentally Friendly Sticker Printing: Redefining Sustainability in Australia', description: 'Choose sustainable sticker printing in Australia to redefine eco-friendliness. Discover our environmentally conscious solutions for all your printing needs.', keywords: 'Sticker Printing' },
  'blogs/embrace-sustainability-with-eco-friendly-printing-solutions': { title: 'Embrace Sustainability With Environmentally Friendly Printing Solutions', description: 'Embrace sustainability with our eco-friendly printing solutions. Join us in making a positive impact on the environment', keywords: 'Environmentally Friendly Printing Solutions' },
  'blogs/enhance-business-visibility-with-eco-friendly-flyers-and-posters': { title: 'Increase Business Visibility With Eco-friendly Flyers and Posters', description: 'Elevate your brand visibility with eco-friendly flyers and posters. Stand out from the competition while promoting sustainability. Discover our range of eye-catching designs today.', keywords: 'Eco-friendly Flyers and Posters' },
  'blogs/environmentally-friendly-custom-printing-services-across-australia': { title: 'Eco-friendly Custom Printing Services Across Australia', description: 'Need sustainable custom printing services in Australia? Visit our website for eco-friendly printing solutions that are available nationwid', keywords: 'Eco-friendly Custom Printing Services' },
  'blogs/green-printing-solutions-eco-friendly-labels-stickers-in-australia': { title: 'Green Printing Solutions: Environmentally Friendly Labels and Stickers in Australia', description: 'Explore our range of eco-friendly labels and stickers in Australia. With our green printing solutions, you can promote your business while minimizing your environmental footprint.', keywords: 'Green Printing Solutions' },
  'blogs/ink-and-imagination-redefining-booklet-printing-in-the-land-of-oz': { title: 'Revolutionizing Booklet Printing: Ink and Imagination in Australia', description: 'Transform the way you print booklets in Australia with our cutting-edge technology and creative solutions. Explore endless possibilities now!', keywords: 'Booklet Printing' },
  'blogs/introducing-sustainable-printing-co-your-eco-friendly-printing-solution': { title: 'Introducing Sustainable Printing Co., Your Eco-friendly Printing Partner!', description: 'Sustainable Printing Co. offers eco-friendly printing solutions for all your needs. Choose sustainability without compromising on quality.', keywords: 'Eco-friendly Printing Partner' },
  'blogs/recycled-greeting-card-printing-services': { title: 'Eco-friendly Greetings: Advantages of Recycled Greeting Card Printing Services', description: 'Explore the world of eco-friendly greetings and discover the advantages of recycled card printing. Join us in promoting sustainability and reducing waste.', keywords: 'Recycled Greeting Card Printing' },
  'blogs/sustainable-printing-solutions-for-booklets-and-reports': { title: 'Going Green: Sustainable Printing Solutions for Books and Reports', description: 'Find sustainable printing solutions for booklets and reports on our website. Discover eco-friendly options that reduce your carbon footprint', keywords: 'Sustainable Printing Solutions' },
  'blogs/the-art-of-personalised-gift-cards': { title: 'The Art of Personalized Gift Cards: Making Gift Giving More Special', description: 'Elevate your gift-giving experience with personalized gift cards. Create memorable moments with thoughtful presents.', keywords: 'Personalized Gift Cards' },
  'blogs/why-should-we-use-recycled-greeting-cards': { title: 'Why Are Recycled Greeting Cards a Good Idea? The Sustainable Option!', description: 'Explore the benefits of opting for recycled greeting cards. Join us in making environmentally conscious decisions. Visit our site now.', keywords: 'Recycled Greeting Cards' },
  'blogs': { title: 'Eco-friendly Printing Insights | Sustainable Printing Co. Blog', description: 'Dive into the world of sustainable printing with our Eco-Friendly Printing Insights. Join us in making a positive impact on the environment.', keywords: 'Eco-friendly Printing' },
};
...
const SITE_URL = "https://sustainable.testdevurl.com";
const TWITTER_URL = "www.sustainable.testdevurl.com";

// ── Helpers ────────────────────────────────────────────────────────────────────

/** Build a Next.js Metadata object from a Laravel SEO slug. Use in static pages: */
/**   `export const metadata = pageMetadata('contact');` */
export function pageMetadata(seoSlug: string,variantProductId?: number, seoOverride?: string): Metadata {
  const m = seoMetaBySlug[seoSlug];
  if (!m) return {};
    const resolvedSlug = resolveSeoSlug(seoSlug, variantProductId, seoOverride);
  return {
    title: { absolute: m.title },
    description: m.description,
    keywords: m.keywords,
    alternates: {
      canonical: `${SITE_URL}/${resolvedSlug}`,
    },
    openGraph: { title: m.title, description: m.description, type: "website", siteName: "Sustainable Printing", url: `${SITE_URL}/${resolvedSlug}` },
     twitter: {
      card: "summary",
...
export function productMetadata(slug: string, variantProductId?: number, seoOverride?: string): Metadata {
  ...
  if (!m) return {};
  const resolvedSlug = resolveSeoSlug(slug, variantProductId, seoOverride);
  return {
    title: { absolute: m.title },
    description: m.description,
    keywords: m.keywords,
